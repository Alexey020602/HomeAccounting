...
public sealed class TelemetryPipelineBehaviour<TMessage, TResponse>(ActivitySource activitySource, ILogger<TelemetryPipelineBehaviour<TMessage, TResponse>> logger): 
