...
public interface ICategoriesApi
{
    ...
    /// </summary>
    /// <param name="parentId">Optional parent category id. Use null for root categories.</param>
    ...
    /// </remarks>
    [Get("/")]
    Task<IReadOnlyCollection<CategoryDto>> GetCategories([Query] int? parentId);
