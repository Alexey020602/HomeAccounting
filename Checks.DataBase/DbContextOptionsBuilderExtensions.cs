...
public static class DbContextOptionsBuilderExtensions
{
    ...
    {
        if (context is not ChecksContext checksContext) return;
    ...
    private static void AddChecks(this ChecksContext context)
    {
    ...
    private static async Task AddChecksAsync(this ChecksContext context, CancellationToken cancellationToken)
    {
        foreach (var check in Checks)
        {
    ...
    private static Entities.Check CreateCheck(this ChecksContext context, Check check) => new Entities.Check()
    {
    ...
    private static Entities.Product CreateProduct(this ChecksContext context, Product product)
    {
    ...
    private static Category GetCategory(this ChecksContext context, string categoryName)
    {
    ...
    private static Category? GetExistingCategory(this ChecksContext context, string categoryName) =>
        context.Categories.Local.SingleOrDefault(c => c.Name == categoryName);

    private static IQueryable<Category> ExistingCategories(this ChecksContext context) => context.Categories
        .Where(category =>
            CategoriesNames
